...
class CustomFlyControls extends THREE.EventDispatcher {
    ...
    constructor( object, domElement ) {
        ...
        if ( domElement === undefined ) {
            ...
            console.warn( 'THREE.CustomFlyControls: The second parameter "domElement" is now mandatory.' );
            domElement = document;
        ...
        this.updateRotationVector = function () {
            ...
            this.rotationVector.z = 0;//- this.moveState.rollRight + this.moveState.rollLeft; //console.log( 'rotate:', [ this.rotationVector.x, this.rotationVector.y, this.rotationVector.z ] );
...
export default CustomFlyControls;
